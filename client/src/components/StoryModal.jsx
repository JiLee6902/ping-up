...
const StoryModal = ({setShowModal, fetchStories}) => {
    ...
    const bgColors = ["#1f2937", "#374151", "#4b5563", "#6b7280", "#9ca3af", "#d1d5db"]
    ...
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
            ...
            <button onClick={()=> toast.promise(handleCreateStory(), {
                loading: 'Saving...',})} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gray-800 hover:bg-gray-700 active:scale-95 transition cursor-pointer'>
