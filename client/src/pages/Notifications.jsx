...
import { Bell, Heart, MessageCircle, UserPlus, Repeat2, Check, Trash2, CheckCheck, BellRing } from 'lucide-react'
        ...
        <div className='flex items-center justify-between mb-6'>
          ...
          {unreadCount > 0 && (
            <button
              ...
              className='flex items-center gap-1.5 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 px-3 py-1.5 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors cursor-pointer'
            >
        ...
        {loading ? (
          ...
          <div className='text-center py-16 px-4'>
            <div className='w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-full flex items-center justify-center'>
              <BellRing className='w-10 h-10 text-purple-500' />
            </div>
          ...
          <div className='space-y-2'>
            {notifications.map((notification) => (
              <div
                key={notification.id}
                className={`bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border transition-all duration-200 hover:shadow-md group ${
                  notification.isRead
                  ...
                  <div className='relative'>
                    {notification.actor?.profilePicture ? (
                      <img
                        ...
                        className='w-12 h-12 rounded-full object-cover cursor-pointer ring-2 ring-transparent hover:ring-blue-400 transition-all'
                  ...
                  <div className='flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity'>
                    {!notification.isRead && (
                      <button
                        ...
                        className='p-2 text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-full transition-colors cursor-pointer'
                        title='Mark as read'
                      >
                    ...
                    <button
                      ...
                      className='p-2 text-gray-400 hover:text-red-500 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-full transition-colors cursor-pointer'
                      title='Delete'
                    >
